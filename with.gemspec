Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README", "README.rdoc", "Rakefile", "lib/with.rb", "lib/with_on_object.rb", "lib/with_sexp_processor.rb", "script/console", "script/destroy", "script/generate", "test/foo.rb", "test/test_helper.rb", "test/test_with.rb", "test/with_on_object_test.rb", "test/with_test.rb", "with.tmproj"]
  s.has_rdoc = true
  ...
  s.test_files = ["test/test_helper.rb", "test/test_with.rb"]
